...
public class PhotoQuerySearch {
	...
	public List<ProductV2> getProducts(String keywords){		
		...
		try{
			...
			List<ProductV2> result=new ArrayList<ProductV2>();
			NamedNodeMap temp;
			String[] tagsl=null;
			for (int i = 0; i < total; i ++){
				...
				ProductV2 t=new ProductV2(poid,title,tags,urlSq,tagsl.length);
				t.setOriginImg(urlO);
				result.add(t);
			}
			return result;

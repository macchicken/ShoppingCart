...
<c:forEach var="product" items= "${products}"
	varStatus="productCount">
            ...
            <td>${product.title}</td>
               ...
               <td>${product.price}</td>
                <td>
                <a href="${pageContext.request.contextPath}/cartsJson/add/${product.productId}" class="add">add</a>
                <a href="${pageContext.request.contextPath}/cartsJson/remove/${product.productId}" class="remove" classid="${product.productId}">remove</a>
                </td>
           </tr>
